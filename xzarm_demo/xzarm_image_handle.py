...
from xzarm_robot import *
from xzarm_asr import *
from xzarm_image_move import *

import time


def xzarm_image_handle(PROMPT='帮我把绿色方块放在杰瑞上面', input_way='keyboard'):
    '''
    ...
    while n < 5:
        try:
            ...
            result = xzarm_image_move(PROMPT, img_path='temp/vl_now.jpg')
            print('    多模态大模型调用成功！')
            print(result)
            break
    ...
    # 起点，机械臂坐标
    print('像素起点',START_X_CENTER, START_Y_CENTER)
    print('像素终点',END_X_CENTER, END_Y_CENTER)
    START_X_MC, START_Y_MC = hand_eye_calibration(START_X_CENTER, START_Y_CENTER)
    # 终点，机械臂坐标
    END_X_MC, END_Y_MC = hand_eye_calibration(END_X_CENTER, END_Y_CENTER)
    print('起点坐标：',START_X_MC, START_Y_MC)
    print('终点坐标',END_X_MC, END_Y_MC)
